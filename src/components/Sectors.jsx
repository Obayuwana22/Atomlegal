            ...
            >
              <div className="p-8">
                <div className="relative z-10">
                  ...
                  <h3 className="font-semibold text-primary mb-4 group-hover:text-primary-glow transition-colors duration-300">
                    {sector.title}
                  </h3>
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-primary-clr shadow-2xl to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

                {/* Decorative border accent */}
                <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-black scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left" />
              </div>
            </div>
          ))}
        </div>
